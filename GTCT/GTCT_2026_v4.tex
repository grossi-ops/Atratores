...
$\rhostar\approx 0.77594059 > \tfrac{2}{3}$, an asymmetry arising
...
\begin{figure}[h]
  ...
  \caption{%
    ...
    the inner boundary $\rhostar\approx 0.77594059$ (dashed pink),
...
Numerical value: $\rhostar\approx 0.77594059$.
\end{theorem}
...
\begin{figure}[h]
  ...
  \caption{%
    ...
    The pink curve initialised at $\rhostar\approx 0.77594059$
...
\begin{enumerate}
  ...
  \item Inner basin boundary $\rhostar\approx 0.77594059$
        (Theorem~\ref{thm:inner}), not $\tfrac{2}{3}$.
  \item Basin hierarchy
        $\tfrac{1}{3}<\tfrac{2}{3}<0.77594059<0.882<1$
