...
The V4 figure naming is intrinsic to the plotting scripts; no manual relabeling
step is required between script output and Zenodo deposit filenames.

- `fig6_d2_natural.pdf` (also keeps canonical `fig_A_d2_scaling.png`)
